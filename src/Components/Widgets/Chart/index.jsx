  ...
  const [lindinHistoryData, setlindinHistoryData] = useState([
    {
      ...
      userName: "mohit",
      userid: "3723",
      linkedinid: "mohit-chhipa-322@e2e",
      remark: "very good"
    },
    {
      date: "23/01/2024",
      ...
      userName: "navratan",
      userid: "3232",
      linkedinid: "navratan-prajapat-322@e2e",
      remark: "good"
    },
    {
      date: "24/01/2024",
      ...
      userName: "Devanshu",
      userid: "3232",
      linkedinid: "devanshu-gahlot-322@e2e",
      remark: "right"
    },
  ]);
              ...
              <Table id="myTable" className="linkedin">
                <thead>
                  <tr>
                    ...
                    <th onClick={handleshort}>
                      Linkedin ID <FaSort style={{ color: "#BABABA" }} />
                    </th>
                    <th onClick={handleshort}>
