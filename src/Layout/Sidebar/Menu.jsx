import NotificationNoticed from "../Header/RightHeader/NotificationNoticed";
    ...
    Items: [
      ...
      // },
      {
        ...
        children: [
          ...
          { path: `${process.env.PUBLIC_URL}/app/ecommerce/checkout`, title: "Task Reward", type: "link" },
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: `${process.env.PUBLIC_URL}/app/ecommerce/product-page`,
            icon: "email",
            title: "Webinar",
            type: "link",
          },
      ...
      },
      {
        ...
        type: "sub",
        children: [
          { title: "Announcement", type: "link", path: `${process.env.PUBLIC_URL}/forms/widget/datepicker` },
          {
            title: "Notification", type: "link", path: `${process.env.PUBLIC_URL}/NotificationNoticed`,
            Component: <NotificationNoticed />,
          },
        ],
      },
      {
...

      {
        ...
        children: [
          ...
          { path: `${process.env.PUBLIC_URL}/app/ecommerce/orderhistory`, title: "KYC Approvel", type: "link" },

          { path: `${process.env.PUBLIC_URL}/app/ecommerce/cart`, title: "Account Detail", type: "link" },
        ],
      },

      {
        ...
        active: false,
        children: [
          { title: "Project Commision Setting", type: "link", path: `${process.env.PUBLIC_URL}/forms/controls/validation` },
          { title: "Daily Task", type: "link", path: `${process.env.PUBLIC_URL}/forms/controls/input` },
          { path: `${process.env.PUBLIC_URL}/app/todo-app/todo`, icon: "to-do", type: "link", title: "Lead Setting" },
