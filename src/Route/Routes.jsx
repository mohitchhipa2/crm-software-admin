...
import Trannig from "../Components/Application/Task/Trannig";
...
export const routes = [
  ...
  {
    path: `${process.env.PUBLIC_URL}/NotificationNoticed/Dubai`,
    Component: <NotificationNoticed />,
  },
  {
    path: `${process.env.PUBLIC_URL}/ChangePassword/Dubai`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/app/ecommerce/product-page/:layout`,
  ...
  { path: `${process.env.PUBLIC_URL}/Trannig/Dubai`, Component: <Trannig /> },
];
